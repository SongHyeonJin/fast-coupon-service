...
public class KafkaConfig {
    ...
    @Bean
    public ConsumerFactory<String, CouponIssueEventDto> consumerFactory() {
        Map<String, Object> config = new HashMap<>();
        ...
        return new DefaultKafkaConsumerFactory<>(config, new StringDeserializer(), new JsonDeserializer<>(CouponIssueEventDto.class, false));
    }

    @Bean
    public ConcurrentKafkaListenerContainerFactory<String, CouponIssueEventDto> kafkaListenerContainerFactory() {
